...
const About: React.FC = () => {
  ...
  const aboutText = `I'm a passionate DevOps Engineer with a Master of Computer Applications degree, focused on building scalable infrastructure, implementing automation, and creating intelligent workflows that drive business success.

My expertise spans across cloud platforms, containerization, infrastructure as code, and continuous integration/deployment pipelines. I believe in the power of automation to solve complex problems and improve operational efficiency.`;
